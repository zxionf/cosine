...
namespace xel
{
    ...
    {
        vkDestroyShaderModule(xelDevice.device(), vertShaderModule, nullptr);
        vkDestroyShaderModule(xelDevice.device(), fragShaderModule, nullptr);
        vkDestroyPipeline(xelDevice.device(), graphicsPipeline, nullptr);
    }
    ...
    { 
        ...
        auto bindingDescriptions = XelModel::Vertex::getBindingDescriptions();
        auto attributeDescriptions = XelModel::Vertex::getAttributeDescriptions();
        ...
        if(vkCreateGraphicsPipelines(xelDevice.device(), VK_NULL_HANDLE, 1, &pipelineInfo, nullptr, &graphicsPipeline) != VK_SUCCESS)
        {
